...
# ╔═╡ f83749c5-21da-4499-b613-d2f67dbd6917
using Plots
...
# ╔═╡ 8dddfdbf-3523-4aea-ad21-51c65b6604ca
...
# ╔═╡ 16a69f44-01dc-44a7-ac6d-5f663b31a82c
...
# ╔═╡ fcf911b6-f771-4cb9-b662-0f2cc94e3da3
...
# ╔═╡ bbd29b68-e25a-47e5-bfe5-e7bd6184401e
function gaussian_kernel_2D(n; σ = 1)
	r = ones(2*n + 1, 2*n + 1)
	total = 0
	for i in -n:n
		for j in -n:n
     		r[n+1 - i, n+1 - j] = gauss(i, j, σ=σ)
	    	total += r[n+1 - i, n+1 - j]
		end
	end
	return r ./ total
...
# ╔═╡ 21952c07-108d-4599-b674-234f1cf2ecfa
Gray.(gaussian_kernel_2D(3, σ=0.5))

# ╔═╡ c947006b-7dda-4404-9d89-711dea59d880
plotly()

# ╔═╡ 772659ef-7ac2-4983-b2cc-20ac331e521c
surface([gaussian_kernel_2D(7, σ=3);])
...
# ╔═╡ b80dba18-b7e1-45a8-80ea-b916b055da1a
...
# ╔═╡ f7047d08-905d-4278-82bb-305a453e59e9
